...
![우애영 서비스 아키텍처](./architecture.svg?v=20260915-2)
...
![우애영 웹 앱 로그인 화면](./app-screen.svg?v=20260915-2)

브라우저에서 이메일과 비밀번호로 로그인하거나 회원가입할 수 있습니다. 로그인 후 `프로필` → `급여조합` → `영양소 분석` → `제품 추가` 흐름으로 사용합니다.

## 보호소 웹 화면

![우애영 보호소의 로스터 화면](./shelter-screen.svg?v=20260915-2)
